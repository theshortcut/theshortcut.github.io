...
\name{Clayton}{Ferris}
\position{Software Engineer{\enskip\cdotp\enskip}Web and Mobile}
\address{12866 N. Bloomington Loop, Oro Valley AZ 85755}

\mobile{(520)-906-6278}
\email{cferris@gmail.com}
\homepage{claytonferris.com}
\github{theshortcut}
\linkedin{clayferris}
\twitter{@clayferris}
